        ...
        <div>
            <div className="hero min-h-screen " >
                <div className="hero-content flex-col lg:flex-row">
                    <img data-aos="fade-left" src="https://i.ibb.co/r477ChX/dental-clinic-building-with-background-vector-illustration-268834-891.jpg" className="lg:max-w-xl rounded-lg shadow-2xl" />
